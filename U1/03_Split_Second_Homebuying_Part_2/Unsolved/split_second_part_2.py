...
# This function should have the following 4 parameters: home_price,
# expected_sale_price, hurdle_rate, holding_months
# Inside of the function:
# Calculate the present value
# HINT: Present Value = Future Value
# (Face Value of the Loan) / (1 + annual_discount_rate/12) ** remaining_months
