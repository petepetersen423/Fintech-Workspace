...
2. Change the scope of the `accountBalance` variable to `public` to allow other users or contracts to access it. Specifically, making this variable public will allow both you and others to check the balance of ether in the contract when depositing or withdrawing ether.
